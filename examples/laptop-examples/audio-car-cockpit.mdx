...
description: "Control a car cockpit mockup by voice, combining LFM2.5-Audio-1.5B for speech in and out with LFM2-1.2B-Tool for function calling, all running locally."
---
