...
description: "Summarize meetings entirely on your laptop with LFM2-2.6B-Transcript and llama.cpp. No cloud services, no API keys, and no recordings uploaded."
---
