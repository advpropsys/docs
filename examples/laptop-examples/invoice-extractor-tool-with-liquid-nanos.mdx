...
description: "Extract structured JSON from invoices with LFM2.5-VL-1.6B running locally through llama.cpp, with no API costs and no documents leaving your machine."
---
...
![Invoice extraction pipeline: PDF pages to LFM2.5-VL-1.6B to structured JSON payment details](https://github.com/Liquid4All/cookbook/raw/main/examples/invoice-parser/media/diagram.jpg)
