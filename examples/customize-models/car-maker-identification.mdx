...
description: "Fine-tune LFM2-VL to identify car makers from photos, covering structured generation with Outlines and LoRA parameter-efficient fine-tuning."
---
...
![Car maker identification task: a car photo in, the manufacturer name out](/images/examples/customize-models/assets/images/task-01484227e78d02da63eeb840de314523.png)
...
![Confusion matrix for LFM2-VL-3B with raw generation, showing outputs that are not valid car maker names](/images/examples/customize-models/assets/images/confusion_matrix_lfm2_3b_raw_generation-2b4949c6ff212ebbb275982abf4784fb.png)
...
![Structured generation masks tokens incompatible with the target output schema at each decoding step](/images/examples/customize-models/assets/images/structured_generation-7f71325a54f868284e9b80abf22f1a8b.webp)
...
![Confusion matrix for LFM2-VL-3B with structured generation, showing only valid car maker names](/images/examples/customize-models/assets/images/confusion_matrix_lfm2_3b_structured_generation-f93ecf885ff6ee370009f1c97873de1b.png)
...
![LoRA parameter-efficient fine-tuning: frozen base weights with small trainable adapter matrices](/images/examples/customize-models/assets/images/lora-a398107b31f6809c153dc5da650dfea8.webp)
...
![Training loss curves comparing LFM2-VL-3B, LFM2-VL-1.6B, and LFM2-VL-450M](/images/examples/customize-models/assets/images/train_loss-c2adea66041f33f2a8b76c4aeb3b6d01.png)
...
![Evaluation loss curves on held-out data for the fine-tuned LFM2-VL models](/images/examples/customize-models/assets/images/eval_loss-dc36b175d7b477b1a872968ee044c8f6.png)
...
![Confusion matrix for LFM2-VL-3B fine-tuned to checkpoint 1000, reaching 82% accuracy](/images/examples/customize-models/assets/images/confusion_matrix_lfm2_3b_checkpoint_1000-1a88130657b75f5ad0934c2456f71ca5.png)
