...
description: "Build a fully local home assistant that calls tools, from benchmarking and synthetic data through LoRA fine-tuning on Modal and llama.cpp deployment."
---
...
![Local home assistant demo: a voice request triggers a tool call that switches on a smart light](/images/examples/customize-models/home-assistant/Demo.gif)
...
![Home assistant happy path: the local model emits a correct tool call and the device responds](/images/examples/customize-models/home-assistant/happy_path.gif)

![Home assistant failure case: the local model emits a malformed tool call and the device does not respond](/images/examples/customize-models/home-assistant/unhappy_path.gif)
