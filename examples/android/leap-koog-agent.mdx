...
description: "Build on-device AI agents on Android with the Koog framework and LFM2-1.2B, covering tool invocation, context management, and MCP integration."
---
