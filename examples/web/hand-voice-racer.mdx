...
description: "Drive a browser racing game with hand gestures and voice, pairing MediaPipe hand tracking with LFM2.5-Audio-1.5B transcription. Fully client-side."
---
